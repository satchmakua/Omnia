...
- [~] **Slice 2 — Homes that matter (in progress).**
  ...
  - [ ] **Sleep at home + a mood/comfort stat (the first mood system).** Folk **go home to sleep**; owning/sleeping in a home lifts a **mood** stat — which then also gives **debt its eviction/comfort consequence** (deferred from D39).
  - [ ] **Landlords collect rent** from the homeless who shelter with them (a real income → "landlord" becomes mechanical, not just a label).
