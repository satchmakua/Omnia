...
## ▶ Milestone 16 — Conflict: Combat, Hunting, Crime & War  *(in progress)*
...
- [ ] **Slice 3 — War:** martial tribes with low inter-tribe relations fight over territory; casualties recorded as legends. *(Reuses combat + the M14 Org engine.)*
- [x] Inspector: combat/health detail (✓ veteran line, slice 1); a **crime/justice** view (✓ outlaw line + ⚖ feed, slice 2).
- *Deferred:* weapons/armour items (await inventory), dismemberment/poison, prisons/slavery/drugs/brothels, military hierarchy/mercenaries — noted, not built.
